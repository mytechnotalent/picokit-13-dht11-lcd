...
static void assert_lamps(int red, int yellow, int green) {
    TEST_ASSERT_EQUAL_INT(red, mock_gpio_get(PICOKIT_13_DHT11_LCD_RED_LED_PIN));
    TEST_ASSERT_EQUAL_INT(yellow,
                          mock_gpio_get(PICOKIT_13_DHT11_LCD_YELLOW_LED_PIN));
    TEST_ASSERT_EQUAL_INT(green,
                          mock_gpio_get(PICOKIT_13_DHT11_LCD_GREEN_LED_PIN));
}
...
static void test_status_led_init(void) {
    ...
    TEST_ASSERT_TRUE(s_mock_gpio_dirs[PICOKIT_13_DHT11_LCD_RED_LED_PIN]);
    TEST_ASSERT_TRUE(s_mock_gpio_dirs[PICOKIT_13_DHT11_LCD_YELLOW_LED_PIN]);
    TEST_ASSERT_TRUE(s_mock_gpio_dirs[PICOKIT_13_DHT11_LCD_GREEN_LED_PIN]);
}
 ...
 */
static const uint8_t s_env_pt[] = "{\"n\":13,\"s\":0,\"t\":230,\"h\":610}";
 ...
 */
static const char s_env_known_hex[] = "000102030405060708090a0b0c0d0e0f1011121314151617e5e0615daae3be82113704f4fb7e8a9c697d1a96cdfa3f835d2009870dd0453e73a2317a223a388e80f73ea88b10";
